...
├── [3. 项目图片](#3-项目图片)
│   ├── [3.1 实物图](#31-实物图)
│   ├── [3.2 电路板高清图](#32-电路板高清图)
│   ├── [3.3 2D预览图](#33-2d预览图)
│   └── [3.4 电路原理图](#34-电路原理图)
├── [4. 使用方法与操作说明](#4-使用方法与操作说明)
│   ├── [4.1 初始启动](#41-初始启动)
│   └── [4.2 配网与设置](#42-配网与设置)
├── [5. 系统设计原理](#5-系统设计原理)
│   ├── [5.1 硬件电路设计](#51-硬件电路设计)
│   └── [5.2 软件逻辑架构](#52-软件逻辑架构)
├── [6. 硬件清单 (BOM)](#6-硬件清单-bom)
└── [7. 参考文献与技术标准](#7-参考文献与技术标准)
    ├── [7.1 国际标准与行业规范](#71-国际标准与行业规范)
    └── [7.2 关键元器件规格书](#72-关键元器件规格书)
